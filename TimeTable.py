...
# info = population.get_schedules()[0]
classes = population.get_schedules()[0].get_classes()
for i in range(0, len(classes)):
    tree.insert('', 'end', text=i, values=(i, population.get_schedules()[0].classes[i].get_dept().get_name(),
                                              population.get_schedules()[0].classes[i].get_course().get_name() + " (" +
                                              population.get_schedules()[0].classes[i].get_course().get_number() + ", " + str(population.get_schedules()[0].classes[i].get_course().get_maxNumbOfStudents()) + ")"
                                              ,population.get_schedules()[0].classes[i].get_room().get_number() + " (" + str(population.get_schedules()[0].classes[i].get_room().get_seatingCapacity())+")"
                                           ,population.get_schedules()[0].classes[i].get_instructor().get_name() + " (" + str(population.get_schedules()[0].classes[i].get_instructor().get_id()) + ")",
                           population.get_schedules()[0].classes[i].get_TimeAvilable().get_time() + " (" + str(population.get_schedules()[0].classes[i].get_TimeAvilable().get_id()) + ")"))
